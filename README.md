...
매일 미국 동부시간 오전 8:30 수신을 목표로 주요 행정학·정치학 저널의 최근 온라인 출간 논문을 확인하고,
...
GitHub 예약 실행의 실제 지연을 감안해 워크플로는 동부시간 7:15, 7:35, 7:55에
세 번 예약됩니다. 첫 성공만 발송하고 이후 실행은 하루 1회 가드로 종료됩니다.
